...
import season_1 from '../../imgs/collections/collection-2023/season_1.jpg';
import season_2 from '../../imgs/collections/collection-2023/season_2.jpg';
import season_3 from '../../imgs/collections/collection-2023/season_3.jpg';
import season_4 from '../../imgs/collections/collection-2023/season_4.jpg';
    ...
    const collections = [
        {
            ...
            link: "/collections/collection-2023/spring-collection",
        },
        {
            image: season_2,
            title: "Летняя коллекция",
            link: "/collections/collection-2023/summer-collection",
        },
        {
            image: season_3,
            title: "Осенняя коллекция",
            link: "/collections/collection-2023/autumn-collection",
        },
        {
            image: season_4,
            title: "Зимняя коллекция",
            link: "/collections/collection-2023/winter-collection",
        },
    ];
    ...
    return (
        <main>
            ...
            <div className="date__of__collection__container">
                <div className="date__of__collection">Коллекции 2023-го года:</div>
            </div>
