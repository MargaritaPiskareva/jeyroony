...
import season_1 from '../../imgs/collections/collection-2021/season_1.jpg';
import season_2 from '../../imgs/collections/collection-2021/season_2.jpg';
import season_3 from '../../imgs/collections/collection-2021/season_3.jpg';
import season_4 from '../../imgs/collections/collection-2021/season_4.jpg';


function Collection2021() {
    ...
    const collections = [
        {
            ...
            link: "/collections/collection-2021/spring-collection",
        },
        {
            image: season_2,
            title: "Летняя коллекция",
            link: "/collections/collection-2021/summer-collection",
        },
        {
            image: season_3,
            title: "Осенняя коллекция",
            link: "/collections/collection-2021/autumn-collection",
        },
        {
            image: season_4,
            title: "Зимняя коллекция",
            link: "/collections/collection-2021/winter-collection",
        },
    ];
    ...
    return (
        <main>
            ...
            <div className="date__of__collection__container">
                <div className="date__of__collection">Коллекции 2021-го года:</div>
            </div>
